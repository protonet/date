...
function parser(str, offset, lang) {
  ...
  var fullDay = !(this.date.changed('hours') || this.date.changed('minutes') || this.date.changed('seconds'));

  return { date: this.date.date, newStr: this.newStr, fullDay: fullDay };
}
